...
class HandeyeCalibrationParametersProvider:
    def __init__(self, node: Node):
        ...
        self.node.declare_parameter('name', 'dadad',descriptor=ParameterDescriptor(type=ParameterType.PARAMETER_STRING))
        self.node.declare_parameter('calibration_type','eye_in_hand', descriptor=ParameterDescriptor(type=ParameterType.PARAMETER_STRING))
        self.node.declare_parameter('robot_base_frame','tr_1', descriptor=ParameterDescriptor(type=ParameterType.PARAMETER_STRING))
        self.node.declare_parameter('robot_effector_frame','tr_2', descriptor=ParameterDescriptor(type=ParameterType.PARAMETER_STRING))
        self.node.declare_parameter('tracking_base_frame', 'tr_base',descriptor=ParameterDescriptor(type=ParameterType.PARAMETER_STRING))
        self.node.declare_parameter('tracking_marker_frame', 'tr_marker',descriptor=ParameterDescriptor(type=ParameterType.PARAMETER_STRING))
